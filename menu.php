...
<?php 
	...
	// grab dessert
	$dessert = $conn->query("SELECT * FROM products WHERE type='dessert' ");
	$dessert->execute();
	$allDessert = $dessert->fetchAll(PDO::FETCH_OBJ);
	    		...
	    		<div class="info">
	    			<div class="row no-gutters">
	    				<div class="col-md-4 d-flex ftco-animate">
	    					...
	    					<div class="text">
	    						<h3>+91 12345-12345</h3>
	    						<p>Its my dream Coffee-Blend </p>
	    					</div>
	    				</div>
	    				<div class="col-md-4 d-flex ftco-animate">
	    					...
	    					<div class="text">
	    						<h3>"Coffee-Blend"</h3>
	    						<p>	360005 Rajkot,Gujarat,India.</p>
	    					</div>
	    				</div>
	    				<div class="col-md-4 d-flex ftco-animate">
    ...
    <section class="ftco-section">
        ...
        <div class="row">
        	...
        	<div class="col-md-6">
				...
				<?php foreach($allDessert as $dessert) :?>
