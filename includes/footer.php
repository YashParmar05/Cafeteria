          ...
          <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">"Akshar Cafe", Rajkot,Gujarat,India.</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 12345-12345</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">yash@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
  ...
  <script src="<?php echo APPURL; ?>/js/cart-quantity-button.js"></script>
  <script src="<?php echo APPURL; ?>/js/valid-email.js"></script>
