...
<?php
  ...
  if(isset($_SESSION['username'])){
    header("location: ".APPURL.""); // OR below line to redirect page
  }
  ...
  if(isset($_POST['submit'])){
    if(empty($_POST['username']) or empty($_POST['email']) or empty($_POST['password'])){
      ...
      header("location:login.php"); // OR below to redirect 
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 ftco-animate">
			<form name="registerForm" action="register.php" method="POST" class="billing-form ftco-bg-dark p-3 p-md-5">
