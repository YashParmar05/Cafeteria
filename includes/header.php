<?php 
      session_start();
      define("APPURL","http://localhost/cefeteria");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>Welcome in Akshar Cafe</title>
    
    <!-- favicon -->
    <link rel="icon" type="image/x-icon" href="<?php echo APPURL; ?>/images/aksharcafe1.png"> 
  ...
  <body>
      ...
      <a class="navbar-brand" href="<?php echo APPURL; ?>"><img src="<?php echo APPURL; ?>/images/aksharcafe1.png" style="width:100px;height:100px; position:relative; top:0px; left: 120px;" alt="Akshar Cafe logo"></a>
      </div>
    	    
	    <div class="container">
	      <a class="navbar-brand" href="<?php echo APPURL; ?>">Akshar<small> Cafe</small></a>
